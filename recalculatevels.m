...
function [s]=recalculatevels(s)
    ...
    s.stagevelocities=cellfun(@(a) parabolicdiff(a,psize), s.stagepositions,'uniformoutput',0);
    s.stageaccelerations=cellfun(@(a) parabolicdiff(a,psize), s.stagevelocities,'uniformoutput',0);
    s.stagevelocities2=cellfun(@(a) parabolicdiff(a,psize), s.stagepositions2,'uniformoutput',0);
