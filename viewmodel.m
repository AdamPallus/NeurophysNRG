...
if formula
    [s.mLeft2,s.mRight2,s.leftShift2,s.rightShift2]=bestFit(s,0,formula);
else
    [s.mLeft2,s.mRight2,s.leftShift2,s.rightShift2]=bestFit(s,1);
end
    ...
    if ~isempty(spiketimes)
        ...
        if length(spiketimes)>3
            ...
            title(sprintf(['(white)Model1 = ',m.Formula.char,...
                ...
                m.Rsquared.Ordinary,shift,m2.Rsquared.Ordinary))
        end
...
function [mLeft, mRight,bestLeft,bestRight]= bestFit(r,fitTtype,formula)
if nargin<2
