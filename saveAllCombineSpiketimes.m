...
function saveAllCombineSpiketimes
...
for f =1:length(filenames)
    ...
    bb=load([filepath, filename(1:9),'-spiketimes.mat']);
    ...
    bb=bb.o;
    savetab.(fn)=outerjoin(t,bb,'keys','trialnum','mergekeys',1);
    savename=[fn,'-updated.mat'];
